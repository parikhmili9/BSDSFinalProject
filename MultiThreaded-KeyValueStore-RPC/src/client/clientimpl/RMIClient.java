...
public class RMIClient {
  ...
  public void start() {
    try {
      ...
      RemoteServer remoteServer = (RemoteServer) registry.lookup(this.name);
      //code here
      new ClientKeyValueController(remoteServer, new InputStreamReader(System.in), System.out).start();
